                    ...
                    <div key={project._id} className='w-screen flex-shrink-0 snap-center flex flex-col
                     space-y-5 items-center justify-center p-20 md:p-44 h-screen'>
                        ...
                        <div className='space-y-10 px-0 md:px-10 mx-w-6xl'>
                            ...
                            <h4 className='text-3xl font-semibold text-center text-[#EF476F]'>
                                <span className=''>Case Study {i + 1} of {projects.length}:
                                </span>{" "}
                                <Link href={project?.linkToBuild}> <span className='underline'>{project?.title}</span></Link>
